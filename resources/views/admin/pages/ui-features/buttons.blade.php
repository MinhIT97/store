                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="template-demo">
                                ...
                                <button type="button" class="btn btn-gradient-danger btn-fw">
                                    Danger
                                </button>
                                <button type="button" class="btn btn-gradient-warning btn-fw">
                                    Warning
                                </button>
                                <button type="button" class="btn btn-gradient-info btn-fw">
                                    Info
                                </button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="template-demo">
                                ...
                                <button type="button" class="btn btn-gradient-light btn-rounded btn-fw">
                                    Light
                                </button>
                                <button type="button" class="btn btn-gradient-dark btn-rounded btn-fw">
                                    Dark
                                </button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="template-demo">
                                ...
                                <button type="button" class="btn btn-outline-light text-black btn-fw">
                                    Light
                                </button>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                Add class
                                <code>.btn-inverse-{color} for
                                    inverse buttons</code>
                            </p>
                            <div class="template-demo">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                Use any of the available button
                                classes to quickly create a styled
                                button.
                            </p>
                            <div class="template-demo">
                                ...
                                <button type="button" class="btn btn-gradient-light">
                                    Light
                                </button>
                                <button type="button" class="btn btn-gradient-dark">
                                    Dark
                                </button>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="template-demo mt-2">
                                        ...
                                        <button class="btn btn-outline-dark btn-icon-text">
                                            ...
                                            <span class="d-inline-block text-left">
                                                <small class="font-weight-light d-block">Get it on
                                                    the</small>
                                                Google Play
                                            </span>
                                        </button>

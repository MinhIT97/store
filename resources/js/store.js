...
$(document).ready(function () {
    ...
    function imuplAddFile(f) {
        ...
        var thisElement = $('<div class="imupl-file-item loading" data-imupl-offset="' + thisOffset + '"><div class="imupl-button-remove"><i class="mdi mdi-delete-forever"></i></div><div class="imupl-button-edit"><i class="fa fa-crop"></i></div><input type="hidden" name="imupl-payload[]" value="" /></div>');
        var reader = new FileReader();
        reader.onload = function (e) {
            var img = new Image;
            img.onload = function () {
